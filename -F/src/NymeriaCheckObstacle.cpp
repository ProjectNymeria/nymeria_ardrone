 ...
 * \param data variable where the value is stored, must be
 *const
 */
 ...
 * Contains the navdata subscriber, sets the security
 *distance to 100.0 and the speed factor to 1.0 by default
...
/**
 * Update the distance between the drone and the obstacle,
 *this value is stored in a ROS param named
...
/**
 * Regulation method
 * Updates the speed factor stored in the ROS param
 *"nymeriaFactor" according to the user orignial command and
 *the estimated pitch of the drone
 * @param userCmd original command sent by user. Represented
 *as a double corresponding to a linear speed factor
...
/**
 * First regulataion of the speed factor command regarding
 *the drone distance to obstacle
 *
 * @param[in] dist_To_Obstacle distance of the drone from
 *the obstacle
...
double NymeriaCheckObstacle::pilotage ( const double& dist_To_Obstacle, const double& securityDist, const double& userCmd   ){
        ...
        double cmdFactor = (dist_To_Obstacle - securityDist) / 100; //new
                                                                    // command
                                                                    // caculated
                                                                    // according
                                                                    // to
...
/**
 * Conversion between the pitch of the drone and the speed
 *factor
 *
 ...
 * @param currentCmd current value of the variable to
 *saturate
